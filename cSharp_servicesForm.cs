// C# "Create a form in C# that interacts with different desktop services, letting you open and close them. Needs to link to the guiAPI_servicesForm.cs when possible."
